...
//127.0.0.1   6969  testJS

//static  NSString * Khost = @"k28hbbvo.xiaomy.net";
//static const uint16_t Kport = 80;
//static const NSString *path = @"webSocket/hhhh";

//static  NSString * Khost = @"127.0.0.1";
//static const uint16_t Kport = 6969;
//static const NSString *path = @"";
...
-(void)initSocket
{
    ...
    webSocket = [[SRWebSocket alloc]initWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"ws://%@:%ld/%@", self.kHost, (long)self.kPort,self.kPath]]];
