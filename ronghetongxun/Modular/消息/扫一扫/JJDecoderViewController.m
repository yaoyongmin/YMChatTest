...
//    [self.view addSubview:torchSwitch];
    ...
    [button setImage:[UIImage imageNamed:unSelectImageNames[1]] forState:UIControlStateNormal];
    [button setImage:[UIImage imageNamed:selectImageNames[1]] forState:UIControlStateHighlighted];
    button.frame=CGRectMake(16, 0, 65, 87);
    ...
    [button1 setImage:[UIImage imageNamed:unSelectImageNames[0]] forState:UIControlStateNormal];
    [button1 setImage:[UIImage imageNamed:selectImageNames[0]] forState:UIControlStateHighlighted];
    button1.frame=CGRectMake(self.view.frame.size.width - 65 -16 , 0, 65, 87);
    [button1 addTarget:self action:@selector(pressPhotoLibraryButton:) forControlEvents:UIControlEventTouchUpInside];
    [scanImageView addSubview:button1];
